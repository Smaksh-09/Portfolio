...
export default function About() {
  return (
    <section id="contact" className="min-h-screen pt-24 pb-32 bg-black relative">
      ...
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          className="max-w-3xl mx-auto text-gray-300 text-lg leading-relaxed mb-20 text-center"
        >
          <p>
